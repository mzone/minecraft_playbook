...
/** vol01 きのいえ */
// 4×4の家。外周12ブロック×2段 + ドア
// x=east(0-3), y=south(0-3), z=up(0-1)
// 正面(ドア側)はy=0。入口はx=1,x=2のy=0列
export const vol01Steps: Step[] = [
  // ── じゅんびへん ──────────────────────────────────────
  {
    stepNumber: 1, totalSteps: 12, label: "きに ちかづこう",
    parts: [],
    blocks: [],
    description: [
      "きが みえたら あるいて ちかづこう",
      "きの すぐ そばまで いけば だいじょうぶ",
    ],
  },
  {
    stepNumber: 2, totalSteps: 12, label: "きを こわそう",
    parts: [{ color: LOG, label: "まるた (Oak Log)", count: 1 }],
    blocks: [
      { id: "log0", x: 1, y: 1, z: 0, color: LOG, isNew: true },
    ],
    description: [
      "きのみきを みつけよう",
      "ひだりクリックを おしつづけると ひびが はいるよ",
      "こわれたら まるた が ちに おちるよ",
    ],
  },
  {
    stepNumber: 3, totalSteps: 12, label: "まるたを 8こ あつめよう",
    parts: [{ color: LOG, label: "まるた (Oak Log)", count: 8 }],
    blocks: [
      { id: "l0", x: 0, y: 0, z: 0, color: LOG, isNew: true },
      { id: "l1", x: 1, y: 0, z: 0, color: LOG, isNew: true },
      { id: "l2", x: 2, y: 0, z: 0, color: LOG, isNew: true },
      { id: "l3", x: 3, y: 0, z: 0, color: LOG, isNew: true },
      { id: "l4", x: 0, y: 1, z: 0, color: LOG, isNew: true },
      { id: "l5", x: 1, y: 1, z: 0, color: LOG, isNew: true },
      { id: "l6", x: 2, y: 1, z: 0, color: LOG, isNew: true },
      { id: "l7", x: 3, y: 1, z: 0, color: LOG, isNew: true },
    ],
    description: [
      "ちかづくと まるた が じぶんで はいるよ",
      "おなじように くりかえして 8こ あつめよう",
    ],
  },
  {
    stepNumber: 4, totalSteps: 12, label: "いたを つくろう",
    recipes: [R_PLANK],
    parts: [{ color: PLANK, label: "いた (Oak Planks)", count: 32 }],
    blocks: [
      { id: "p0", x: 0, y: 0, z: 0, color: PLANK, isNew: true },
      { id: "p1", x: 1, y: 0, z: 0, color: PLANK, isNew: true },
      { id: "p2", x: 2, y: 0, z: 0, color: PLANK, isNew: true },
      { id: "p3", x: 3, y: 0, z: 0, color: PLANK, isNew: true },
    ],
    description: [
      "「E」キーで もちものを ひらこう",
      "みぎうえの 2×2に まるたを 1こ いれよう",
      "いた が 4まい できるよ — まるた 8こぶん くりかえそう",
    ],
  },
  {
    stepNumber: 5, totalSteps: 12, label: "ものづくりだいを つくろう",
    recipes: [R_TABLE],
    parts: [{ color: TABLE, label: "ものづくりだい (Crafting Table)", count: 1 }],
    blocks: [
      { id: "tb", x: 1, y: 2, z: 0, color: TABLE, isNew: true },
    ],
    description: [
      "「E」キーで もちものを ひらこう",
      "2×2の 4マスぜんぶに いた を いれよう",
      "ものづくりだい ができたら うけとって ちめんに おこう",
    ],
  },
  {
    stepNumber: 6, totalSteps: 12, label: "ドアを つくろう",
    recipes: [R_DOOR],
    parts: [{ color: DOOR, label: "ドア (Oak Door)", count: 1 }],
    blocks: [
      { id: "tb", x: 1, y: 2, z: 0, color: TABLE },
      { id: "d0", x: 1, y: 0, z: 0, color: DOOR, isNew: true },
    ],
    description: [
      "ものづくりだいに ちかづいて 右クリックしよう",
      "3×3の ひだり 2れつ ぜんぶに いた を いれよう（6まい）",
      "ドア が 3こ できるよ — 1こ うけとろう",
    ],
  },
  // ── つくろうへん ──────────────────────────────────────
  {
    stepNumber: 7, totalSteps: 12, label: "ばしょを きめよう",
    parts: [],
    blocks: [],
    description: [
      "たいらな くさはらを さがそう",
      "4×4マスぶんの ひろさが あれば だいじょうぶ",
      "ばしょが きまったら おぼえておこう",
    ],
  },
  {
    stepNumber: 8, totalSteps: 12, label: "かべを 1だん おこう",
    parts: [{ color: PLANK, label: "いた (Oak Planks)", count: 12 }],
    cameraOffset: { x: -20, y: 20 },
    blocks: [
      // 4×4 外周 z=0（y=0 前面4, y=3 背面4, x=0/x=3 側面各2）
      { id: "f0", x: 0, y: 0, z: 0, color: PLANK, isNew: true },
      { id: "f1", x: 1, y: 0, z: 0, color: PLANK, isNew: true },
      { id: "f2", x: 2, y: 0, z: 0, color: PLANK, isNew: true },
      { id: "f3", x: 3, y: 0, z: 0, color: PLANK, isNew: true },
      { id: "b0", x: 0, y: 3, z: 0, color: PLANK, isNew: true },
      { id: "b1", x: 1, y: 3, z: 0, color: PLANK, isNew: true },
      { id: "b2", x: 2, y: 3, z: 0, color: PLANK, isNew: true },
      { id: "b3", x: 3, y: 3, z: 0, color: PLANK, isNew: true },
      { id: "l0", x: 0, y: 1, z: 0, color: PLANK, isNew: true },
      { id: "l1", x: 0, y: 2, z: 0, color: PLANK, isNew: true },
      { id: "r0", x: 3, y: 1, z: 0, color: PLANK, isNew: true },
      { id: "r1", x: 3, y: 2, z: 0, color: PLANK, isNew: true },
    ],
    description: [
      "そとがわ ぐるっと 12まい おこう",
      "いた を もって、ちめんを 右クリックで おけるよ",
    ],
  },
  {
    stepNumber: 9, totalSteps: 12, label: "かべを 2だんに しよう",
    parts: [{ color: PLANK, label: "いた (Oak Planks)", count: 12 }],
    cameraOffset: { x: -20, y: 20 },
    blocks: [
      // z=0 既存
      ...
      { id: "f3", x: 3, y: 0, z: 0, color: PLANK },
      { id: "b0", x: 0, y: 3, z: 0, color: PLANK },
      { id: "b1", x: 1, y: 3, z: 0, color: PLANK },
      { id: "b2", x: 2, y: 3, z: 0, color: PLANK },
      { id: "b3", x: 3, y: 3, z: 0, color: PLANK },
      { id: "l0", x: 0, y: 1, z: 0, color: PLANK },
      { id: "l1", x: 0, y: 2, z: 0, color: PLANK },
      { id: "r0", x: 3, y: 1, z: 0, color: PLANK },
      { id: "r1", x: 3, y: 2, z: 0, color: PLANK },
      // z=1 新規
      { id: "f0t", x: 0, y: 0, z: 1, color: PLANK, isNew: true },
      { id: "f1t", x: 1, y: 0, z: 1, color: PLANK, isNew: true },
      { id: "f2t", x: 2, y: 0, z: 1, color: PLANK, isNew: true },
      { id: "f3t", x: 3, y: 0, z: 1, color: PLANK, isNew: true },
      { id: "b0t", x: 0, y: 3, z: 1, color: PLANK, isNew: true },
      { id: "b1t", x: 1, y: 3, z: 1, color: PLANK, isNew: true },
      { id: "b2t", x: 2, y: 3, z: 1, color: PLANK, isNew: true },
      { id: "b3t", x: 3, y: 3, z: 1, color: PLANK, isNew: true },
      { id: "l0t", x: 0, y: 1, z: 1, color: PLANK, isNew: true },
      { id: "l1t", x: 0, y: 2, z: 1, color: PLANK, isNew: true },
      { id: "r0t", x: 3, y: 1, z: 1, color: PLANK, isNew: true },
      { id: "r1t", x: 3, y: 2, z: 1, color: PLANK, isNew: true },
    ],
    description: [
      "1だんめの うえに もう1だん おこう",
      "おなじように ぐるっと 12まい おけば 2だん かんりょう！",
    ],
  },
  {
    stepNumber: 10, totalSteps: 12, label: "あなを あけよう",
    parts: [],
    cameraOffset: { x: -20, y: 20 },
    blocks: [
      // z=0 — 正面 x=1,x=2 を除く
      ...
      { id: "r1", x: 3, y: 2, z: 0, color: PLANK },
      // z=1 — 正面 x=1,x=2 を除く
      { id: "f0t", x: 0, y: 0, z: 1, color: PLANK },
      { id: "f3t", x: 3, y: 0, z: 1, color: PLANK },
      { id: "b0t", x: 0, y: 3, z: 1, color: PLANK },
      { id: "b1t", x: 1, y: 3, z: 1, color: PLANK },
      { id: "b2t", x: 2, y: 3, z: 1, color: PLANK },
      { id: "b3t", x: 3, y: 3, z: 1, color: PLANK },
      { id: "l0t", x: 0, y: 1, z: 1, color: PLANK },
      { id: "l1t", x: 0, y: 2, z: 1, color: PLANK },
      { id: "r0t", x: 3, y: 1, z: 1, color: PLANK },
      { id: "r1t", x: 3, y: 2, z: 1, color: PLANK },
    ],
    description: [
      "まえの かべの まんなか 2マスを こわそう",
      "したと うえ、2こ こわすとドアが はいるよ",
      "ひだりクリック おしつづけで こわせるよ",
    ],
  },
  {
    stepNumber: 11, totalSteps: 12, label: "ドアを つけよう",
    parts: [{ color: DOOR, label: "ドア (Oak Door)", count: 1 }],
    cameraOffset: { x: -20, y: 20 },
    blocks: [
      { id: "f0", x: 0, y: 0, z: 0, color: PLANK },
      ...
      { id: "r0t", x: 3, y: 1, z: 1, color: PLANK },
      { id: "r1t", x: 3, y: 2, z: 1, color: PLANK },
      // ドア（x=1,x=2, y=0, z=0 and z=1）
      { id: "d0", x: 1, y: 0, z: 0, color: DOOR, isNew: true },
      { id: "d1", x: 2, y: 0, z: 0, color: DOOR, isNew: true },
      { id: "d2", x: 1, y: 0, z: 1, color: DOOR, isNew: true },
      { id: "d3", x: 2, y: 0, z: 1, color: DOOR, isNew: true },
    ],
    description: [
      "ドアを もって、あなの したの マスを 右クリックしよう",
      "じどうで 2マスぶん ドアが つくよ",
    ],
  },
  {
    stepNumber: 12, totalSteps: 12, label: "ドアを あけてみよう！",
    parts: [],
    cameraOffset: { x: -20, y: 20 },
    blocks: [
      { id: "f0", x: 0, y: 0, z: 0, color: PLANK },
      ...
      { id: "r1t", x: 3, y: 2, z: 1, color: PLANK },
      // ドア（開いた状態 — x=1 側に回転）
      { id: "dopen0", x: 1, y: 1, z: 0, color: DOOR, isNew: true },
      { id: "dopen1", x: 1, y: 1, z: 1, color: DOOR, isNew: true },
    ],
    description: [
      "ドアに ちかづいて 右クリックしよう",
      "ドアが ひらくよ！なんどでも あけたり しめたり してみよう",
      "きのいえの かんせい！",
    ],
  },
];
...
export const VOLUMES: Record<VolumeId, VolumeInfo> = {
  vol01: { id: "vol01", title: "きのいえ",           subtitle: "はじめての おうち",       steps: vol01Steps },

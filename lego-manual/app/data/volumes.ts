...
export const vol01Steps: Step[] = [
  {
    ...
    blocks: [
      ...
      { id: "p2", x: 0, y: 0, z: 1, color: PLANK, isNew: true },
      { id: "p3", x: 1, y: 0, z: 1, color: PLANK, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "p2", x: 0, y: 0, z: 1, color: PLANK },
      { id: "p3", x: 1, y: 0, z: 1, color: PLANK },
      { id: "tb", x: 0, y: 1, z: 0, color: TABLE, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "p2", x: 0, y: 0, z: 1, color: PLANK },
      { id: "p3", x: 1, y: 0, z: 1, color: PLANK },
      { id: "tb", x: 0, y: 1, z: 0, color: TABLE },
      { id: "w0", x: 0, y: 2, z: 0, color: PLANK, isNew: true },
      { id: "w1", x: 1, y: 2, z: 0, color: PLANK, isNew: true },
      { id: "w2", x: 0, y: 2, z: 1, color: PLANK, isNew: true },
      { id: "w3", x: 1, y: 2, z: 1, color: PLANK, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "p2", x: 0, y: 0, z: 1, color: PLANK },
      { id: "p3", x: 1, y: 0, z: 1, color: PLANK },
      { id: "w0", x: 0, y: 2, z: 0, color: PLANK },
      { id: "w1", x: 1, y: 2, z: 0, color: PLANK },
      { id: "w2", x: 0, y: 2, z: 1, color: PLANK },
      { id: "w3", x: 1, y: 2, z: 1, color: PLANK },
      { id: "d0", x: 0, y: 1, z: 0, color: DOOR, isNew: true },
      { id: "d1", x: 1, y: 1, z: 0, color: DOOR, isNew: true },
...
export const vol02Steps: Step[] = [
  {
    ...
    blocks: [
      ...
      { id: "b2", x: 0, y: 0, z: 1, color: LOG, isNew: true },
      { id: "b3", x: 1, y: 0, z: 1, color: LOG, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "b2", x: 0, y: 0, z: 1, color: LOG },
      { id: "b3", x: 1, y: 0, z: 1, color: LOG },
      { id: "t0", x: 0, y: 1, z: 0, color: TABLE, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "b2", x: 0, y: 0, z: 1, color: LOG },
      { id: "b3", x: 1, y: 0, z: 1, color: LOG },
      { id: "c0", x: 0, y: 3, z: 0, color: LOG, isNew: true },
      { id: "c1", x: 1, y: 3, z: 0, color: LOG, isNew: true },
      { id: "c2", x: 0, y: 3, z: 1, color: LOG, isNew: true },
      { id: "c3", x: 1, y: 3, z: 1, color: LOG, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "b2", x: 0, y: 0, z: 1, color: LOG },
      { id: "b3", x: 1, y: 0, z: 1, color: LOG },
      { id: "c0", x: 0, y: 3, z: 0, color: LOG },
      { id: "c1", x: 1, y: 3, z: 0, color: LOG },
      { id: "c2", x: 0, y: 3, z: 1, color: LOG },
      { id: "c3", x: 1, y: 3, z: 1, color: LOG },
      { id: "l0", x: 0, y: 1, z: 0, color: STICK, isNew: true },
      { id: "l1", x: 0, y: 2, z: 0, color: STICK, isNew: true },
      { id: "l2", x: 0, y: 3, z: 0, color: STICK, isNew: true },
    ],
  },
];
...
export const vol03Steps: Step[] = [
  {
    ...
    blocks: [
      ...
      { id: "f3", x: 0, y: 0, z: 1, color: PLANK, isNew: true },
      { id: "f4", x: 2, y: 0, z: 1, color: PLANK, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "f3", x: 0, y: 0, z: 1, color: PLANK },
      { id: "f4", x: 2, y: 0, z: 1, color: PLANK },
      { id: "bd", x: 1, y: 1, z: 0, color: BED, isNew: true },
    ],
  },
  {
    stepNumber: 3, totalSteps: 4, label: "ドアを つくろう",
    ...
    blocks: [
      ...
      { id: "f3", x: 0, y: 0, z: 1, color: PLANK },
      { id: "f4", x: 2, y: 0, z: 1, color: PLANK },
      { id: "bd", x: 1, y: 1, z: 0, color: BED },
      { id: "w0", x: 0, y: 1, z: 0, color: PLANK, isNew: true },
      { id: "w1", x: 2, y: 1, z: 0, color: PLANK, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "f4", x: 2, y: 0, z: 1, color: PLANK },
      { id: "bd", x: 1, y: 1, z: 0, color: BED },
      { id: "w0", x: 0, y: 1, z: 0, color: PLANK },
      { id: "w1", x: 2, y: 1, z: 0, color: PLANK },
      { id: "d0", x: 1, y: 1, z: 1, color: DOOR, isNew: true },
      { id: "r0", x: 0, y: 2, z: 0, color: LOG, isNew: true },
      { id: "r1", x: 1, y: 2, z: 0, color: LOG, isNew: true },
      { id: "r2", x: 2, y: 2, z: 0, color: LOG, isNew: true },
    ],
  },
];
...
export const vol04Steps: Step[] = [
  {
    ...
    blocks: [
      ...
      { id: "d3", x: 0, y: 0, z: 1, color: WATER, isNew: true },
      { id: "d4", x: 1, y: 0, z: 1, color: WATER, isNew: true },
      { id: "d5", x: 2, y: 0, z: 1, color: WATER, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "d3", x: 0, y: 0, z: 1, color: WATER },
      { id: "d4", x: 1, y: 0, z: 1, color: WATER },
      { id: "d5", x: 2, y: 0, z: 1, color: WATER },
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: "d4", x: 1, y: 0, z: 1, color: WATER },
      { id: "d5", x: 2, y: 0, z: 1, color: WATER },
      { id: "d6", x: 0, y: 0, z: 2, color: WATER, isNew: true },
      { id: "d7", x: 1, y: 0, z: 2, color: WATER, isNew: true },
      { id: "d8", x: 2, y: 0, z: 2, color: WATER, isNew: true },
...
export const vol05Steps: Step[] = [
  {
    ...
    blocks: [
      ...
      { id: "g3", x: 0, y: 0, z: 2, color: GRASS, isNew: true },
      { id: "g4", x: 1, y: 0, z: 2, color: GRASS, isNew: true },
      { id: "g5", x: 2, y: 0, z: 2, color: GRASS, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "g3", x: 0, y: 0, z: 2, color: GRASS },
      { id: "g4", x: 1, y: 0, z: 2, color: GRASS },
      { id: "g5", x: 2, y: 0, z: 2, color: GRASS },
      { id: "f0", x: 0, y: 1, z: 0, color: FENCE, isNew: true },
      { id: "f1", x: 1, y: 1, z: 0, color: FENCE, isNew: true },
      { id: "f2", x: 2, y: 1, z: 0, color: FENCE, isNew: true },
      { id: "f3", x: 0, y: 1, z: 2, color: FENCE, isNew: true },
      { id: "f4", x: 1, y: 1, z: 2, color: FENCE, isNew: true },
      { id: "f5", x: 2, y: 1, z: 2, color: FENCE, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "g4", x: 1, y: 0, z: 2, color: GRASS },
      { id: "g5", x: 2, y: 0, z: 2, color: GRASS },
      { id: "f0", x: 0, y: 1, z: 0, color: FENCE },
      { id: "f1", x: 1, y: 1, z: 0, color: FENCE },
      { id: "f2", x: 2, y: 1, z: 0, color: FENCE },
      { id: "f3", x: 0, y: 1, z: 2, color: FENCE },
      { id: "f4", x: 1, y: 1, z: 2, color: FENCE },
      { id: "f5", x: 2, y: 1, z: 2, color: FENCE },
...
export const vol06Steps: Step[] = [
  {
    ...
    blocks: [
      ...
      { id: "s2", x: 0, y: 0, z: 1, color: STONE, isNew: true },
      { id: "s3", x: 1, y: 0, z: 1, color: STONE, isNew: true },
      { id: "k0", x: 0, y: 1, z: 0, color: COBBLE, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "r0", x: 0, y: 1, z: 0, color: RAIL, isNew: true },
      { id: "r1", x: 1, y: 1, z: 0, color: RAIL, isNew: true },
      { id: "r2", x: 2, y: 1, z: 0, color: RAIL, isNew: true },
      { id: "r3", x: 3, y: 1, z: 0, color: RAIL, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "g2", x: 2, y: 0, z: 0, color: DIRT },
      { id: "g3", x: 3, y: 0, z: 0, color: DIRT },
      { id: "r0", x: 0, y: 1, z: 0, color: RAIL },
      { id: "r1", x: 1, y: 1, z: 0, color: RAIL },
      { id: "r2", x: 2, y: 1, z: 0, color: RAIL },
      { id: "r3", x: 3, y: 1, z: 0, color: RAIL },
      { id: "mc", x: 1, y: 2, z: 0, color: IRON, isNew: true },
    ],
  },
];
...
export const vol07Steps: Step[] = [
  {
    ...
    blocks: [
      { id: "d0", x: 0, y: 0, z: 0, color: DIRT, isNew: true },
      { id: "d1", x: 1, y: 0, z: 0, color: DIRT, isNew: true },
      { id: "d2", x: 0, y: 0, z: 1, color: DIRT, isNew: true },
      { id: "d3", x: 1, y: 0, z: 1, color: DIRT, isNew: true },
      { id: "d4", x: 0, y: 1, z: 0, color: DIRT, isNew: true },
      { id: "d5", x: 1, y: 1, z: 0, color: DIRT, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      { id: "d0", x: 0, y: 0, z: 0, color: DIRT },
      { id: "d1", x: 1, y: 0, z: 0, color: DIRT },
      { id: "d2", x: 0, y: 0, z: 1, color: DIRT },
      { id: "d3", x: 1, y: 0, z: 1, color: DIRT },
      { id: "d4", x: 0, y: 1, z: 0, color: DIRT },
      { id: "d5", x: 1, y: 1, z: 0, color: DIRT },
      { id: "d6", x: 0, y: 2, z: 0, color: DIRT, isNew: true },
      { id: "d7", x: 1, y: 2, z: 0, color: DIRT, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "d4", x: 0, y: 1, z: 0, color: DIRT },
      { id: "d5", x: 1, y: 1, z: 0, color: DIRT },
      { id: "d6", x: 0, y: 2, z: 0, color: DIRT },
      { id: "d7", x: 1, y: 2, z: 0, color: DIRT },
      { id: "w0", x: 0, y: 3, z: 0, color: WATER, isNew: true },
      { id: "w1", x: 0, y: 2, z: 1, color: WATER, isNew: true },
      { id: "w2", x: 0, y: 1, z: 2, color: WATER, isNew: true },
    ],
  },
];
...
export const vol08Steps: Step[] = [
  {
    ...
    blocks: [
      ...
      { id: "g1", x: 1, y: 0, z: 0, color: GRASS, isNew: true },
      { id: "g2", x: 2, y: 0, z: 0, color: GRASS, isNew: true },
      { id: "g3", x: 0, y: 0, z: 1, color: GRASS, isNew: true },
      { id: "g4", x: 2, y: 0, z: 1, color: GRASS, isNew: true },
      { id: "g5", x: 0, y: 0, z: 2, color: GRASS, isNew: true },
      { id: "g6", x: 1, y: 0, z: 2, color: GRASS, isNew: true },
      { id: "g7", x: 2, y: 0, z: 2, color: GRASS, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "g1", x: 1, y: 0, z: 0, color: GRASS },
      { id: "g2", x: 2, y: 0, z: 0, color: GRASS },
      { id: "g3", x: 0, y: 0, z: 1, color: GRASS },
      { id: "g4", x: 2, y: 0, z: 1, color: GRASS },
      { id: "g5", x: 0, y: 0, z: 2, color: GRASS },
      { id: "g6", x: 1, y: 0, z: 2, color: GRASS },
      { id: "g7", x: 2, y: 0, z: 2, color: GRASS },
      { id: "gv", x: 1, y: 0, z: 1, color: GRAVEL, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "g6", x: 1, y: 0, z: 2, color: GRASS },
      { id: "g7", x: 2, y: 0, z: 2, color: GRASS },
      { id: "gv0", x: 1, y: 0, z: 1, color: GRAVEL },
...
export const vol09Steps: Step[] = [
  {
    ...
    blocks: [
      ...
      { id: "w3", x: 0, y: 0, z: 1, color: WATER, isNew: true },
      { id: "w4", x: 1, y: 0, z: 1, color: WATER, isNew: true },
      { id: "w5", x: 2, y: 0, z: 1, color: WATER, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "w3", x: 0, y: 0, z: 1, color: WATER },
      { id: "w4", x: 1, y: 0, z: 1, color: WATER },
      { id: "w5", x: 2, y: 0, z: 1, color: WATER },
      { id: "d0", x: 0, y: 1, z: 2, color: PLANK, isNew: true },
      { id: "d1", x: 1, y: 1, z: 2, color: PLANK, isNew: true },
      { id: "d2", x: 2, y: 1, z: 2, color: PLANK, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "w4", x: 1, y: 0, z: 1, color: WATER },
      { id: "w5", x: 2, y: 0, z: 1, color: WATER },
      { id: "d0", x: 0, y: 1, z: 2, color: PLANK },
      { id: "d1", x: 1, y: 1, z: 2, color: PLANK },
      { id: "d2", x: 2, y: 1, z: 2, color: PLANK },
...
export const vol10Steps: Step[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: "f4", x: 0, y: 0, z: 1, color: FARMLAND, isNew: true },
      { id: "f5", x: 1, y: 0, z: 1, color: FARMLAND, isNew: true },
      { id: "f6", x: 2, y: 0, z: 1, color: FARMLAND, isNew: true },
      { id: "f7", x: 3, y: 0, z: 1, color: FARMLAND, isNew: true },
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: "f2", x: 2, y: 0, z: 0, color: FARMLAND },
      { id: "f3", x: 3, y: 0, z: 0, color: FARMLAND },
      { id: "f4", x: 0, y: 0, z: 1, color: FARMLAND },
      { id: "f5", x: 1, y: 0, z: 1, color: FARMLAND },
      { id: "f6", x: 2, y: 0, z: 1, color: FARMLAND },
      { id: "f7", x: 3, y: 0, z: 1, color: FARMLAND },
      { id: "wr", x: 4, y: 0, z: 0, color: WATER },
      { id: "w0", x: 0, y: 1, z: 0, color: WHEAT, isNew: true },
      { id: "w1", x: 1, y: 1, z: 0, color: WHEAT, isNew: true },
      { id: "w2", x: 2, y: 1, z: 0, color: WHEAT, isNew: true },
      { id: "w3", x: 3, y: 1, z: 0, color: WHEAT, isNew: true },
    ],
  },
];
...
export const vol11Steps: Step[] = [
  {
    ...
    blocks: [
      ...
      { id: "b1", x: 1, y: 1, z: 0, color: "#C47B30", isNew: true },
      { id: "b2", x: 2, y: 1, z: 0, color: "#C47B30", isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "b1", x: 1, y: 1, z: 0, color: "#C47B30" },
      { id: "b2", x: 2, y: 1, z: 0, color: "#C47B30" },
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: "r0", x: 0, y: 2, z: 0, color: PLANK, isNew: true },
      { id: "r1", x: 1, y: 2, z: 0, color: PLANK, isNew: true },
      { id: "r2", x: 2, y: 2, z: 0, color: PLANK, isNew: true },
    ],
  },
];
...
export const vol12Steps: Step[] = [
  {
    ...
    blocks: [
      ...
      { id: "g2", x: 2, y: 0, z: 0, color: GRASS, isNew: true },
      { id: "g3", x: 0, y: 0, z: 2, color: GRASS, isNew: true },
      { id: "g4", x: 2, y: 0, z: 2, color: GRASS, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "g2", x: 2, y: 0, z: 0, color: GRASS },
      { id: "g3", x: 0, y: 0, z: 2, color: GRASS },
      { id: "g4", x: 2, y: 0, z: 2, color: GRASS },
      { id: "f0", x: 0, y: 1, z: 0, color: FENCE, isNew: true },
      { id: "f1", x: 2, y: 1, z: 0, color: FENCE, isNew: true },
      { id: "f2", x: 0, y: 1, z: 2, color: FENCE, isNew: true },
      { id: "f3", x: 2, y: 1, z: 2, color: FENCE, isNew: true },
      { id: "f4", x: 1, y: 1, z: 2, color: FENCE, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "g4", x: 2, y: 0, z: 2, color: GRASS },
      { id: "f0", x: 0, y: 1, z: 0, color: FENCE },
      { id: "f1", x: 2, y: 1, z: 0, color: FENCE },
      { id: "f2", x: 0, y: 1, z: 2, color: FENCE },
      { id: "f3", x: 2, y: 1, z: 2, color: FENCE },
      { id: "f4", x: 1, y: 1, z: 2, color: FENCE },
      { id: "f5", x: 1, y: 1, z: 0, color: FENCE, isNew: true },
...
export const vol13Steps: Step[] = [
  {
    ...
    blocks: [
      { id: "f0", x: 0, y: 0, z: 0, color: PLANK, isNew: true },
      { id: "f1", x: 1, y: 0, z: 0, color: PLANK, isNew: true },
      { id: "f2", x: 0, y: 0, z: 1, color: PLANK, isNew: true },
      { id: "f3", x: 1, y: 0, z: 1, color: PLANK, isNew: true },
      { id: "w0", x: 0, y: 1, z: 0, color: PLANK, isNew: true },
      { id: "w1", x: 1, y: 1, z: 0, color: PLANK, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      { id: "f0", x: 0, y: 0, z: 0, color: PLANK },
      { id: "f1", x: 1, y: 0, z: 0, color: PLANK },
      { id: "f2", x: 0, y: 0, z: 1, color: PLANK },
      { id: "f3", x: 1, y: 0, z: 1, color: PLANK },
      { id: "w0", x: 0, y: 1, z: 0, color: PLANK },
      { id: "w1", x: 1, y: 1, z: 0, color: PLANK },
      { id: "r0", x: 0, y: 2, z: 0, color: LOG, isNew: true },
      { id: "r1", x: 1, y: 2, z: 0, color: LOG, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "w0", x: 0, y: 1, z: 0, color: PLANK },
      { id: "w1", x: 1, y: 1, z: 0, color: PLANK },
      { id: "r0", x: 0, y: 2, z: 0, color: LOG },
      { id: "r1", x: 1, y: 2, z: 0, color: LOG },
      { id: "wf", x: 2, y: 1, z: 0, color: WOLF, isNew: true },
    ],
  },
];
...
export const vol14Steps: Step[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: "s2", x: 0, y: 0, z: 1, color: STONE },
      { id: "s3", x: 0, y: 1, z: 0, color: COBBLE, isNew: true },
      { id: "t0", x: 1, y: 1, z: 0, color: TORCH, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "t0", x: 1, y: 1, z: 0, color: TORCH },
      { id: "or", x: 2, y: 0, z: 0, color: "#AA8855", isNew: true },
      { id: "t1", x: 2, y: 1, z: 0, color: TORCH, isNew: true },
      { id: "t2", x: 3, y: 1, z: 0, color: TORCH, isNew: true },
    ],
  },
];
...
export const vol15Steps: Step[] = [
  {
    ...
    blocks: [
      ...
      { id: "s4", x: 2, y: 0, z: 1, color: COBBLE, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "s4", x: 2, y: 0, z: 1, color: COBBLE },
      { id: "w0", x: 0, y: 1, z: 0, color: COBBLE, isNew: true },
      { id: "w1", x: 1, y: 1, z: 0, color: GLASS, isNew: true },
      { id: "w2", x: 2, y: 1, z: 0, color: COBBLE, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "s3", x: 0, y: 0, z: 1, color: COBBLE },
      { id: "s4", x: 2, y: 0, z: 1, color: COBBLE },
      { id: "w0", x: 0, y: 1, z: 0, color: COBBLE },
      { id: "w1", x: 1, y: 1, z: 0, color: GLASS },
      { id: "w2", x: 2, y: 1, z: 0, color: COBBLE },
...
export const vol16Steps: Step[] = [
  {
    ...
    blocks: [
      ...
      { id: "s3", x: 0, y: 0, z: 2, color: SNOW, isNew: true },
      { id: "s4", x: 2, y: 0, z: 2, color: SNOW, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "i3", x: 0, y: 0, z: 1, color: ICE, isNew: true },
      { id: "i4", x: 1, y: 0, z: 1, color: ICE, isNew: true },
      { id: "i5", x: 2, y: 0, z: 1, color: ICE, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "i3", x: 0, y: 0, z: 1, color: ICE },
      { id: "i4", x: 1, y: 0, z: 1, color: ICE },
      { id: "i5", x: 2, y: 0, z: 1, color: ICE },
      { id: "s0", x: 0, y: 1, z: 0, color: SNOW, isNew: true },
      { id: "s1", x: 1, y: 1, z: 0, color: SNOW, isNew: true },
      { id: "s2", x: 2, y: 1, z: 0, color: SNOW, isNew: true },
      { id: "s3", x: 0, y: 1, z: 1, color: SNOW, isNew: true },
      { id: "s4", x: 2, y: 1, z: 1, color: SNOW, isNew: true },
      { id: "s5", x: 1, y: 2, z: 0, color: SNOW, isNew: true },
    ],
  },
];
...
export const vol17Steps: Step[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: "w4", x: 1, y: 0, z: 1, color: WATER },
      { id: "w5", x: 2, y: 0, z: 1, color: WATER },
      { id: "g0", x: 0, y: 1, z: 0, color: GLASS, isNew: true },
      { id: "g1", x: 1, y: 1, z: 0, color: GLASS, isNew: true },
      { id: "g2", x: 2, y: 1, z: 0, color: GLASS, isNew: true },
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: "w4", x: 1, y: 0, z: 1, color: WATER },
      { id: "w5", x: 2, y: 0, z: 1, color: WATER },
      { id: "g0", x: 0, y: 1, z: 0, color: GLASS },
      { id: "g1", x: 1, y: 1, z: 0, color: GLASS },
      { id: "g2", x: 2, y: 1, z: 0, color: GLASS },
      { id: "g3", x: 0, y: 1, z: 1, color: GLASS },
      { id: "g4", x: 2, y: 1, z: 1, color: GLASS },
      { id: "d0", x: 1, y: 1, z: 1, color: DOOR, isNew: true },
      { id: "r0", x: 0, y: 2, z: 0, color: GRAVEL, isNew: true },
      { id: "r1", x: 1, y: 2, z: 0, color: GRAVEL, isNew: true },
      { id: "r2", x: 2, y: 2, z: 0, color: GRAVEL, isNew: true },
    ],
  },
];
...
export const vol18Steps: Step[] = [
  {
    ...
    blocks: [
      ...
      { id: "f1", x: 1, y: 0, z: 0, color: PLANK, isNew: true },
      { id: "f2", x: 2, y: 0, z: 0, color: PLANK, isNew: true },
      { id: "ch", x: 1, y: 1, z: 0, color: CHEST, isNew: true },
    ],
  },
  {
...
export const vol19Steps: Step[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: "c3", x: 0, y: 0, z: 1, color: CHEST, isNew: true },
      { id: "c4", x: 1, y: 0, z: 1, color: CHEST, isNew: true },
      { id: "c5", x: 2, y: 0, z: 1, color: CHEST, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "c1", x: 1, y: 0, z: 0, color: CHEST },
      { id: "c2", x: 2, y: 0, z: 0, color: CHEST },
      { id: "c3", x: 0, y: 0, z: 1, color: CHEST },
      { id: "c4", x: 1, y: 0, z: 1, color: CHEST },
      { id: "c5", x: 2, y: 0, z: 1, color: CHEST },
      { id: "s0", x: 0, y: 1, z: 0, color: PLANK, isNew: true },
      { id: "s1", x: 1, y: 1, z: 0, color: PLANK, isNew: true },
      { id: "s2", x: 2, y: 1, z: 0, color: PLANK, isNew: true },
    ],
  },
];
...
export const vol20Steps: Step[] = [
  {
    ...
    blocks: [
      ...
      { id: "g1", x: 1, y: 0, z: 0, color: GRASS, isNew: true },
      { id: "g2", x: 2, y: 0, z: 0, color: GRASS, isNew: true },
      { id: "g3", x: 0, y: 0, z: 1, color: WATER, isNew: true },
      { id: "g4", x: 1, y: 0, z: 1, color: FARMLAND, isNew: true },
      { id: "g5", x: 2, y: 0, z: 1, color: SNOW, isNew: true },
    ],
  },
  {
    ...
    blocks: [
      ...
      { id: "g1", x: 1, y: 0, z: 0, color: GRASS },
      { id: "g2", x: 2, y: 0, z: 0, color: GRASS },
      { id: "g3", x: 0, y: 0, z: 1, color: WATER },
      { id: "g4", x: 1, y: 0, z: 1, color: FARMLAND },
      { id: "g5", x: 2, y: 0, z: 1, color: SNOW },
      { id: "f0", x: 0, y: 1, z: 0, color: FENCE, isNew: true },
      { id: "f1", x: 1, y: 1, z: 0, color: FENCE, isNew: true },
      { id: "f2", x: 2, y: 1, z: 0, color: FENCE, isNew: true },
      { id: "f3", x: 0, y: 1, z: 2, color: FENCE, isNew: true },

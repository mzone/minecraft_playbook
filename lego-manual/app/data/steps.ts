...
export const RECIPE_TABLE: CraftingRecipe = {
  ...
  howTo: [
    ...
    "みぎに「ものづくりだい」が でてきたら クリックして うけとろう",
    "もちものに「ものづくりだい」が はいったら、ちめんを 右クリックして おこう",
...
export const RECIPE_DOOR: CraftingRecipe = {
  ...
  tableRequired: true,
  howTo: [
    "おいた「ものづくりだい」に ちかづいて 右クリックしよう",
    "3×3の クラフト画面が ひらくよ",
    "「いた」を ひだりの 2れつ に ぜんぶ（6まい）いれよう — みぎの 1れつは あけておいてね",
    "みぎに「ドア ×3」が でてきたら クリックして うけとろう",
